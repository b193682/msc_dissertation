#!/bin/bash
# Polygenic risk score analysis for bipolar disorder, using C+T threshold derived from Choi and O'Reilly (2020) https://doi.org/10.1038/s41596-020-0353-1
# PRS calculated using PRSice-2 v2.1.11 https://choishingwan.github.io/PRSice/
# Discovery dataset from O'Connell et al. (2025) https://doi.org/10.1038/s41586-024-08468-9
...
# Total score
PRSice \
  --base data/bip2024_eur_noUKB_no23andMe.gz \
