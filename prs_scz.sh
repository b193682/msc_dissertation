#!/bin/bash
# Polygenic risk score analysis for schizophrenia, using C+T threshold derived from Choi and O'Reilly (2020) https://doi.org/10.1038/s41596-020-0353-1
# PRS calculated using PRSice-2 v2.1.11 https://choishingwan.github.io/PRSice/
# Discovery dataset from Trubetskoy et al. (2022) https://doi.org/10.1038/s41586-022-04434-5
...
#$ -o /home/xxxxxxxx/gwas_pipeline/logs/prs_scz.log
#$ -e /home/xxxxxxxx/gwas_pipeline/logs/prs_scz.err

#Initialise the modules system to work in qsub job scripts.
. /etc/profile.d/modules.sh
module load igmm/apps/PRSice/2.1.11

# PRS for schizophrenia against all four SPQ-B phenotypes

# Total score
PRSice \
  --base data/PGC3_SCZ_clean.gz \
